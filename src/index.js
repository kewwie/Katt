...
(async () => {
    ...
    await Database.query("CREATE TABLE IF NOT EXISTS userRoles (id INTEGER PRIMARY KEY AUTOINCREMENT, userId VARCHAR(100), guildId VARCHAR(100), roleId VARCHAR(100))", { logging: false })
})();

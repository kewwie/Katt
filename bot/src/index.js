...
(async () => {
    ...
    await Database.query("CREATE TABLE IF NOT EXISTS servers (guildId VARCHAR(100) PRIMARY KEY, verifiedRole VARCHAR(100), logsChannel VARCHAR(100), pendingChannel VARCHAR(100), verificationAdmin VARCHAR(100))");
})();
